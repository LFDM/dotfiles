...
function! s:state_proto.select_word()
	...
	let l = col('.') != 1 ? 'l' : ''
	if &sel == 'exclusive'
		" Partially disables placeholders, but retains the current paste
		" buffer!
		return "\<esc>".l.'v'.len."l\"_c"
		"return "\<esc>".l.'v'.len."l\<c-g>"
	endif
	return len == 1 ? "\<esc>".l.'gh' : "\<esc>".l.'v'.(len - 1)."l\"_c"
...
fun! snipMate#TriggerSnippet()
	...
	if pumvisible() " Update snippet if completion is used, or deal with supertab
		" Disabled by LFDM: this is causing trouble..
